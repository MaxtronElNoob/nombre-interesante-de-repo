...
Se requiere tener instalador postgresql y conocer su usuario y contraseña
...
Si tienes docker puedes instalarlo e iniciarlo facilmente con: `docker run --rm -P -p 127.0.0.1:5432:5432 -e POSTGRES_PASSWORD="1234" --name pg postgres:alpine`

## Metodo a usar en este curso (esto muy probablemente lo vieron en BD)
En caso contrario, tendrás que modificar los conections string en el codigo del backend `postgresql://postgres:1234@localhost:5432/postgres` por el que corresponda a tu instalación.
